...
5.  Add `[http://localhost:8888/callback](http://127.0.0.1:8080/)` (or your chosen URI) to the **Redirect URIs** in Settings.
...
# Run generation script (you will need to create this file)
